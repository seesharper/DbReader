namespace DbReader.Readers
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of <see cref="Tuple"/> to be created.</typeparam>
    public class KeyReaderMethodBuilder<T> : ReaderMethodBuilder<T> 
    {
        ...
        public KeyReaderMethodBuilder(IMethodSkeletonFactory methodSkeletonFactory, IMethodSelector methodSelector, IConstructorSelector firstConstructorSelector)

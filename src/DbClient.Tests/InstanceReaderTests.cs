namespace DbClient.Tests
{
    ...
    public class InstanceReaderTests : ContainerFixture
    {
        ...
        public void ShouldReadNullableEnumWithConverterFunction()
        {
            ...
            DbClientOptions.WhenReading<EnumWithConverterFunction>().Use((dataRecord, ordinal) =>
            {
                wasCalled = true;
        ...
        public void ShouldReadNullableEnumWithConverterFunctionForIntegralType()
        {
            var dataRecord = new { Id = 1, Property = 2 }.ToDataRecord();
            bool wasCalled = false;
            DbClientOptions.WhenReading<ushort>().Use((dataRecord, ordinal) =>
            {
                wasCalled = true;
        ...
        {
            DbClientOptions.WhenReading<Int32Enum>().Use((dr, i) => (Int32Enum)dr.GetInt64(i));
        ...
        public void ShouldNotUseDefaultValue()
        {
            ...
            DbClientOptions.WhenReading<CustomValueType>().Use((dr, i) => new CustomValueType(dr.GetInt32(i))).WithDefaultValue(new CustomValueType(82));
            var reader = GetReader<ClassWithProperty<CustomValueType>>();
            var instance = reader.Read(dataRecord, string.Empty);
            instance.Property.Value.ShouldBe(42);
        }
        ...
        public void Test()
        {
            DbClientOptions.WhenReading<IEnumerable<ClassWithId>>().Use((dr, ordinal) =>
            {
